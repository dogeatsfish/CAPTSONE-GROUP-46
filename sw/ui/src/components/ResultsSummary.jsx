    ...
    return (
        <div className="panel">
            ...
            <div className="results-grid">
                ...
                <div className="card">
                    <div className="label">Trade Throughput</div>
                    <div className="value">{m ? `${fmtNumber(m.trades_per_second, 1)} trades/s` : "—"}</div>
                </div>
                <div className="card">
            ...
            {m && (
                <div className="hint" style={{ marginTop: 14 }}>
                    Trade Throughput is total trades ÷ engine compute time -- how fast the C++
                    engine processed this run, not a market-timing figure. Sharpe is annualized
                    from per-second PnL samples (252 trading days × 23,400s/day). Volatility is
                    the standard deviation of second-over-second PnL change.
                </div>
            )}
        </div>
    );
