// Converts one PnL snapshot -- one entry of a SimulationResponse-shaped
// pnl_curve -- into the shape PnlCharts/StatCards expect:
// { t, realized, unrealized, total, position }, with `t` = seconds since
// `firstTs`.
